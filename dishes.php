...
<head>
    ...
    <link rel="icon" href="#">
    <title>Dishes || Online Food Ordering System - homemade</title>
    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="https://o.remove.bg/downloads/c90b44ff-617d-4e7a-bbc6-f18089adc9e4/homemade-removebg-preview.png" alt="" width="18%"> </a>
        ...
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Choose items</a></li>
