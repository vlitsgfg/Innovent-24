    ...
    <section class="u-clearfix u-section-1" id="carousel_9522">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-expanded-width-xs u-form u-palette-1-light-3 u-radius-10 u-form-1">
          <form action="https://forms.nicepagesrv.com/v2/form/process" class="u-clearfix u-form-spacing-40 u-form-vertical u-inner-form" source="email" name="form" style="padding: 28px;">
            ...
            <div class="u-form-email u-form-group">
              ...
              <input type="email" placeholder="enter password" id="email-4c18" name="password" class="u-border-2 u-border-grey-90 u-custom-font u-font-merriweather u-input u-input-rectangle u-palette-1-base u-radius-15 u-input-2" required="">
            </div>
            ...
            <input type="hidden" name="formServices" value="88a22133-10fd-77bd-bdb4-37d74da7bcdf">
          </form>
        </div>
        <a href="admin-login.html" class="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-6 u-btn-2">submit</a>
      </div>
    </section>
...
$name = $_POST['name'];
$pass  = $_POST['password']; 
$query="SELECT * FROM teacher_login where username='$name' and password='$pass'";
