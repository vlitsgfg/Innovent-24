...
<head>
    ...
    <link rel="icon" href="#">
    <title>Home || Online Food Ordering System - Homemade</title>
    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="https://o.remove.bg/downloads/c90b44ff-617d-4e7a-bbc6-f18089adc9e4/homemade-removebg-preview.png" alt="" width="15%"> </a>
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                        <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                        <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Homemade<span class="sr-only"></span></a> </li>
            ...
            <div class="container text-center hero-text font-white">
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;">1. </span>Choose items</h4>
                    </div>
                    <!--  Author Name: MH RONY.
                        GigHub Link: https://github.com/dev-mhrony
                        Facebook Link:https://www.facebook.com/dev.mhrony
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Popular Home Dishes of the Week</h2>
                <p class="lead">Easiest way to order your homemade food among top 6 homefoods</p>
            </div>
            <div class="row">
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3>Choose a items</h3>
                                <p>We"ve got your covered with menus from a variety of delivery home foods and spices online.</p>
                            </div>
                        </div>
                    </div>
                    <!--  Author Name: MH RONY.
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Choose a dish</h3>
                            <p>We"ve got your covered with a variety of delivery home foods and spices online.</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <p>Get your food/spices delivered!taste the Home Food ! </p>
                        </div>
                    </div>
                </div>
            </div>
